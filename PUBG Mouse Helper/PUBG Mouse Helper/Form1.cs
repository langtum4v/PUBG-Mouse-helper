...
namespace PUBG_Mouse_Helper
{
    public partial class Form1 : Form, IOkButtonPressedInSavePresetDialog, IOnHotkeyPressed
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            poller.Poll(trackBarDy.Value, trackBarShotInterval.Value, trackBarPullDelay.Value, toolStripComboBoxFireButton.Text, autoToolStripMenuItem.Text);
        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //Load_Preset.GetPresetValuesFromName();
...
";
        ...
        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            if (toolStripMenuItem1.Checked)
                Poller.Auto_Tap = true;
            else
                Poller.Auto_Tap = false;
        }
    }
